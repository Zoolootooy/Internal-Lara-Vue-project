...
class PageCategory extends Resource
{
    /**
    ...
    {
        return parent::indexQuery($request, $query)->withCount('pages');
    }
    ...
    {
        return parent::detailQuery($request, $query->withCount('pages'));
    }
    ...
    public function generalFields()
    {
        return [
            ...
            Badge::make(__('Pages'), 'pages_count')->map([
                $this->pages_count => 'info',
            ]),
